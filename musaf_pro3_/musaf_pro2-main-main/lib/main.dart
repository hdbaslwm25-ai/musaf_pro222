  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      onGenerateRoute: (settings) {
        final String patientId = settings.arguments is String
        ...
        switch (settings.name) {
          case '/caregiver_home':
            ...
            return MaterialPageRoute(
              builder: (context) =>
                  caregiver_home.HomeScreen(caregiverId: caregiverId),
            );
          case '/map':
            return MaterialPageRoute(
              builder: (context) => MapScreen(patientId: patientId),
            );
          case '/add_zone':
            return MaterialPageRoute(
              builder: (context) => AddZoneScreen(patientId: patientId),
            );
          case '/notifications':
            return MaterialPageRoute(
              builder: (context) => FamilyAlertsScreen(patientId: patientId),
            );
          default:
            return null;
        }
  ...
  void _showPermissionDialog() {
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: const Text(
          "يرجى السماح بالوصول للموقع والإشعارات لعمل التطبيق.",
        ),
        actions: [
          ElevatedButton(
            onPressed: () async {
